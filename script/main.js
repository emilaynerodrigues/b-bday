  ...
  function countdown() {
    var birthdayDate = new Date(
      "April 24, " + new Date().getFullYear() + " 00:00:00"
    ).getTime();
    ...
    var interval = setInterval(function () {
      ...
      if (difference < 0) {
        birthdayDate = new Date(
          "April 24, " + (new Date().getFullYear() + 1) + " 00:00:00"
        ).getTime();
      }
      ...
      var isApril24 = todayDate === 24 && todayMonth === 4;

      if (isApril24) {
        // Mostra a div desejada durante todo o dia 24
        // Substitua 'suaDiv' pelo ID da sua div
  ...
  correctButton.addEventListener("click", function () {
    ...
    setTimeout(function () {
      // Mostre a estrela amarela definindo sua opacidade para 1
